...
const StudentDashboard = () => {
    ...
    useEffect(() => {
        // Fetch student's own products
        // We will just fetch all live products, in a real app would filter by user ID.
        // Actually, let's skip fetching own products for brevity, or we can use the existing API if it had a user filter
    }, []);
